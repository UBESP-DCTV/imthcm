...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/UBESP-DCTV/imthcm?branch=master&svg=true)](https://ci.appveyor.com/project/UBESP-DCTV/imthcm)
...
To run th emodules you have to say to the system that they are "executable"
by
```
